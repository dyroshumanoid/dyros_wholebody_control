...
public:
   ...
   * support : link data w.r.t. support frame
   */
  Eigen::Matrix3Vd local_Jac_v;
  Eigen::Matrix3Vd local_Jac_w;
  Eigen::Matrix6Vd local_Jac;
  Eigen::Vector6d  local_Jqdot;

  Eigen::Vector3d local_xpos;
  Eigen::Matrix3d local_rotm;
  Eigen::Vector3d local_v;
  Eigen::Vector3d local_w;
  Eigen::Vector3d local_xpos_init;
  Eigen::Matrix3d local_rotm_init;
  Eigen::Vector3d local_v_init;
  Eigen::Vector3d local_w_init;

  Eigen::Vector3d support_xpos;
  Eigen::Matrix3d support_rotm;
  Eigen::Vector3d support_v;
  Eigen::Vector3d support_w;
  Eigen::Vector3d support_xpos_init;
  Eigen::Matrix3d support_rotm_init;
  Eigen::Vector3d support_v_init;
  Eigen::Vector3d support_w_init;
};
